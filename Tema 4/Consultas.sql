...
*/
-- Se seleccionan los nombres y salarios de la tabla de empleados, filtrando los salarios
...
-- se ordena por salario total en orden descendente y se limita a los 3 que mas cobran.
...
/*
14. Obtener en orden alfabético los salarios y nombres de los empleados cuyo salario sea superior
al 60% del máximo salario de la empresa.
*/
-- Se calcula el 60% del salario máximo usando una subconsulta y se seleccionan los empleados que lo cumplen.
...
*/
-- Se selecciona el empleado con el salario máximo.
...
sus salarios y la suma de sus comisiones.
*/
...
*/
-- Se agrupan los empleados por departamento y se ordena en orden descendente, limitando al primero.
...
*/
-- Se realiza un LEFT JOIN entre departamento y empleado para incluir todos los departamentos, incluso los que no tienen empleados.
...
*/
-- Se utiliza un LEFT JOIN para incluir tanto los departamentos principales como de los que dependen .
...
*/
-- Se seleccionan los empleados cuyo código no aparece en la lista de jefes de departamento, usando NOT IN.
SELECT nombre, ape1, ape2
FROM empleado
